...
public class PersonaServiceImpl implements PersonaService {
    ...
    @Override
    // LISTAR TODOS LOS REGISTROS QUE TENGAN EL ESTADO TRUE
    ...
    // PAGINACION, MOSTRAR CADA CIERTO NUMERO DE REGISTROS EN UNA PAGINA
    @Override
    public Page<PersonaDto> getAllRegistrosPage(Pageable pageable) {
